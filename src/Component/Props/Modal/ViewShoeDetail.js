...
export default class ViewShoeDetail extends Component {
  state = {
    spDetail: {
      id: 12,
    name: "Nike Air Max 270 React",
  ...
  renderListIshoe() {
    return dataListShoe.map((shoe, index) => {
      return (
        <div key={shoe.maSP} className="col-4 px-3">
          <CartDetail
            shoe={shoe}
  ...
  render() {
    ...
    return (
      <div className="container">
        <h3>Xem chi tiết shoe</h3>
        {/* Danh sách sản phẩm */}
        <div className="row">{this.renderListIshoe()}</div>
        {/* Chi tiết sản phẩm */}
